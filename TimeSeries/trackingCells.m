...
% trackingCells.m: Script runs the tracking code of DICOT to track
% detections

% Inputs: 
% all_data output from TimeSeries.m 
% Image path for all_data source data

% Outputs: Script generates tracking movie of dividind cells
